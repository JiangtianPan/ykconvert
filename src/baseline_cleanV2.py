...
# **A题：高校学生毕业情况的大数据分析**  
# 
# 随着高校扩招政策和高校教育质量的不断提升，越来越多的青年人才通过层层筛选和知识的洗礼，迈入社会，希望能在此闯出一片天地。然而，随着教育事业的快速发展，高等学府中学生数量的增多，在每年毕业季时，互联网上总会出现一批又一批的新鲜热词和好笑段子，让网友们在哭笑不得中看到了高等学生“毕业难”的问题。
# 与此同时，高校毕业生人数也屡创新高。2023年高校毕业生人数达1158万人，2024年高校毕业生人数则高达1179万人，就业总量的压力居高不下，高校学生“就业难”的困境也随之进入公众视野。
# 请根据下列任务要求，完成对高校学生毕业情况相关数据的分析。 

# **问题1. （必须涵盖但不限于下述数据预处理操作）**  
# 对train_raw.csv文件中不同教育背景的学生毕业情况进行统计分析并可视化：  
# (1)对数据中的缺失值进行处理（补0）；  
# (2)去除数据中的重复值；  
# (3)对Previous qualification (grade)、Admission grade列进行异常值处理（异常情况说明：不在指定范围内的值均为异常值）；  
# (4)筛选表格中Previous qualification的取值为1, 9, 10, 12, 14, 15, 19, 38的记录作为后续操作步骤的数据集并打印前五行记录。（10分）
